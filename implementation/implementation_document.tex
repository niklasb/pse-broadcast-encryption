...
\item \lstinline|class StreamViewerActivity|
 ...
 \item \lstinline|class ClientActivity|
  ...
  \begin{itemize}
  \item \lstinline|public void onCreateContextMenu(ContextMenu menu, View ContextMenuInfo menuInfo)| was added to 
  create a context menu to edit the server history.
  \item \lstinline|public public boolean onContextItemSelected(MenuItem item)| was added to edit the selected item in the server history
    \end{itemize}
