...
public class NaorPinkasServerContext<T, G extends CyclicGroupOfPrimeOrder<T>> 
    ...
    private int t;
    private G group;
    private Generator<NaorPinkasPersonalKey<T, G>> keyGen;
    private Polynomial<BigInteger> poly;
    private LagrangeInterpolation<BigInteger> lagrange;

    private static SecureRandom rnd = new SecureRandom();
    
    public NaorPinkasServerContext(int t, G group, 
                                   Generator<NaorPinkasPersonalKey<T, G>> keyGen,
    ...
    public Generator<NaorPinkasPersonalKey<T, G>> getKeyGen() { return keyGen; }
    ...
    public static <T, G extends CyclicGroupOfPrimeOrder<T>> 
                     NaorPinkasServerContext<T, G> generate(int t, G group) {
        ...
        Generator<NaorPinkasPersonalKey<T, G>> keyGen = 
                new OptimisticGenerator<NaorPinkasPersonalKey<T, G>>(
                        new NaorPinkasKeyGenerator<T, G>(rnd, group, poly));
        ...
        log.debug("Took {} ms", System.currentTimeMillis() - start);
        return new NaorPinkasServerContext<T, G>(t, group, keyGen, poly, lagrange);
    }
}
