...
\addrow{/FA10/} {Der Server kann Daten versenden.}
\addrow{/FA20/} {Der Server kann Daten verschlüsseln.}
\addrow{/FA30/} {Der Server kann Schlüssel generieren.}
\addrow{/FA40/} {Der Server kann jedem Benutzer einen Schlüssel zuordnen.}
\addrow{/FA50/} {Der Server kann Nutzer ausschließen.}
\addrow{/FA60/} {Der Client kann sich zu einem Server verbinden.}
