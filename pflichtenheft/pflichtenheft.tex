...
\begin{usecase}
\addheading{Nummer}{Beschreibung}
\addrow{/AF10/} {Anmeldung durch privilegierten Benutzer
   \begin{itemize}
   ...
   \item Ereignissfluss: Der Benutzer wird dazu aufgefordert den Anbieter und seinen Schlüssel
         einzugeben. Damit kann er die Daten entschlüsseln, da er nicht explizit ausgeschlossen wurde.
   \end{itemize}
}
\addrow{/AF15/} {Anmeldung durch ausgeschlossenen Benutzer
   \begin{itemize}
   \item Teilnehmender Akteur: Benutzer
