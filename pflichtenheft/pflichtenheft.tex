...
\addrow{/FA90/} {Der Client kann Daten entschlüsseln, nachdem er mit einem
                 g"ultigen Schl"ussel konfiguriert wurde und solange er nicht
                 vom Server explizit ausgeschlossen wurde.}
\addrow{/FA100/} {Der Client merkt sich die letzten ausgewählten Server mit
...
\begin{usecase}
\addheading{Nummer}{Beschreibung}
\addrow{/PD10/} {Benutzerdaten: alle Informationen zu einem Benutzer
              \begin{itemize}
              \item Identifikation
              \begin{itemize}
              ...
              \begin{itemize}
				      ...
				      \item Alter
							...
							\end{itemize}
              \end{itemize} }
\addrow{/PD20/} {Informationen über die Daten, die versendet werden
              \begin{itemize}
		   				\item Art der Daten
							\begin{itemize}
				      \item Audio- oder Videostream
							\end{itemize}
							\item Kosten der Daten
							\end{itemize} }
\addrow{/PD30/} {Performance-Daten}
\end{usecase}
...
\begin{usecase}
\addheading{Nummer}{Beschreibung}
\addrow{/T10/} {Ein Benutzer möchte sich unter Benutzung seines Benutzernames und Passwortes anmelden, 
                aber das Password ist nicht korrekt. Es wird eine Fehlermeldung angezeigt und der Bernuzer
								hat die Möglichkeit noch mal zu versuchen.}
\addrow{/T20/} {Ein Benutzer zahlt keine Gebühren mehr. Sein Zugang wird gesperrt.}
\addrow{/T30/} {Ein Benutzer möchte sein Konto löschen. Die löschung des Kontos wird akzeptiert und das
                Konto wird gelöscht.}
\end{usecase}
