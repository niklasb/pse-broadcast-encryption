...
\begin{usecase}
\addheading{Nummer}{Beschreibung}
\addrow{/PD10/} {Der Server speichert ausgeschlossene Nutzer.}
\addrow{/PD20/} {Der Server ordnet Nutzern einen Schlüssel zu.}
\addrow{/PD30/} {Der Server speichert zur Verschlüsselung erforderliche Daten.}
\addrow{/PD40/} {Daten die Performance betreffend werden auf dem Server gespeichert.}
\end{usecase}
