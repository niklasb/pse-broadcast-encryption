...
Da im Pausenraum aber kein Fernseher zur Verfügung steht, entscheidet er sich für einen mobilen Bezahlsender namens "EconomyDaily". 
Für einen monatlichen Betrag bestellt er die Leistung und ihm wird eine SD-Karte mit einer Schlüsseldatei zugesendet. 
...
hNach der Eingabe der korrekten Schlüsseldatei beginnt der Stream. 

Als Michael ein paar Monate später ein neues Konto eröffnet und sein Altes schließt, vergisst er einen neuen Auftrag einzurichten und der Anbieter erhält so keine Zahlungen mehr. 
