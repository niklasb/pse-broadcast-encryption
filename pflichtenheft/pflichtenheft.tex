...
\begin{itemize}
   \item Die Verbindung des Clients zum Server erfolgt ohne eine zus"atzliche TCP-Verbindung.
         Dazu muss ein Verfahren entwickelt werden, bei dem der Server den Group-Key
...
\addrow{/FA240/} {Um Benutzer mit volumenbasierten Datentarifen nicht zu belasten,
...
\addrow{/TF60/} {Benutzer hinzufügen
   \begin{itemize}
   \item Teilnehmender Akteur: Anbieter
   \item Eingangsbedingung: Es existiert eine Empfängergruppe
...
Der katholische Pfarrer Hans Altwelt will den neuen Video-Stream-Dienst 'Fußball-Bayern' für sein neues Android-Smartphone ausprobieren. Er schließt einen Vertrag mit dem Anbieter ab und zahlt die einmalige Anmeldegebühr. Daraufhin erhält er vom Anbieter einen für ihn ausgestellten privaten Schlüssel und kann, nachdem er die benötigte Software installiert hat, den Dienst nutzen.

Hellauf begeistert erzählt er seinen Jugendfreunden Werner und Otto bei ihrem gemeinsamen Skatabend von seiner Entdeckung. Diese entschließen sich nach einer kleinen Demonstration dafür, dass sie das ganze unbedingt auch brauchen. Nach dem dritten Bier kommen der Informatiker Otto auf die Idee, dass sie, anstatt jeder zu zahlen, auch gemeinsam die Zugangsdaten von Hans nutzen können. Sofort setzen sie den Plan in die Tat um und kopieren den Schlüssel auf ihre Smartphones. Von der Tatsache, dass es funktioniert hellauf begeistert machen sie sich nach drei weiteren Bieren auf den Heimweg. Am örtlichen Kindergarten, der zufällig das Ende des gemeinsamen Heimwegs der drei markiert trennen sie sich. Kaum ist Werner um die nächste Straßenecke verschwunden läuft ihm seine Nachbarin Ute Liebkind über den Weg. Sofoert erzählt er ihr von dem neusten Coup um 'Fußball-Bayern'. Ute ist überhaupt nicht begeistert von dem ihrer Meinung nach kriminellen Vorgehen der drei. Werner tut ihre Einwände damit ab, dass die Firma sowieso zu viel Geld verdiene und sie ja keinem schadeteten. Überhaupt würde das nie jemand merken. 

Als Ute am nächsten Morgen jedoch nach unzähligen Albträumen schlecht gelaunt aufsteht, kann sie ihr schlechtes Gewissen nicht länger ertragen und entschließt sich bei 'Fußball-Bayern' anzurufen und Hans zu melden. Hans wird sofort der Zugang auf Lebenszeit gesperrt und Ute kann die nächste Nacht ohne schlechtes Gewissen schlafen. Beim nächsten Skatabend sind sich Hans, Werner und Otto einig, dass 'Fußball-Bayern' der größte Unsinn auf Erden sei und sie jetzt den Konkurrent 'Regionalfußball Bayern' ausprobieren wollen.

\subsubsection{Härtefall}
Die tüchtige Chefin der Firma "Kraut und Rüben" Angela M. langweiligt sich bei den langwierigen
Debatten an ihrem Arbeitsplatz immer so sehr, dass sie sich entschließt doch
das neue Radio 'Hörgutzu' zu testen, dass ihr Freund Guido W. unlängst
begeistert für sich entdeckt hat. Sie registriert sich online und zahlt per Sofortüberweisung,
damit sie den gerade das Rednerpult erreichenden Oskar L. nicht auch noch ertragen muss.
Verärgert stellt sie fest, dass sie einen privaten Schlüssel benötigt und dessen Versand einige
Minuten in Anspruch nehmen kann. Nachden Oskar L. seine zweiten Satz beendet hat erhält sie ihren
Schlüssel und startet ungeduldig das Radio. Sofort fängt sie begeistert an mit dem Kopf zu wackeln
und erntet dafür einige unverständliche Blicke.

Einige Tage später hat sich der Grund für das neue Dauerlächeln Angelas
während Sitzungen herumgesprochen und alle anderen Teilnehmer haben sich 
bei Radio 'Hörgutzu' registriert. Während der nächsten Sitzung haben alle 
bis auf den diesmal redenden Philip R. ein abwesendes Lächeln auf dem Gesicht.
Nachdem diese Geschehnisse an die Presse gelangt sind und sich ein Skandal bisher ungekannten 
Ausmaßes anbahnt, entschließt sich der Radiosender allen 620 beteiligten Mitarbeiern
den Zugang zu sperren. Da ihrr gegenwärtige Verschlüsselung aber nur auf maximal 500 gesperrte
Nutzer ausgelegt ist, müssen sie ein Rekey durchführen und die Anzahl der gesperrten Nutzer
auf 1000 erhöhen.

Nachdem dies geschehen ist konzentrieren sich endlich alle Mitarbeiter wieder so gut wie
vor dem Vorfall auf ihre Arbeit und es kehrt Ruhe ein.
