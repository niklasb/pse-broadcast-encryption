...
\tikzset{
  rect/.style={draw,fill=green!60,minimum height=0.8cm,rectangle},
  box/.style={
    draw=blue!50!white,
    line width=1pt,
...
\node[rect,fill=green!15,minimum width=2cm](server) {\textbf{Server}};
\node[rect,fill=red!60,minimum width=2cm,xshift=4.5cm,right of=server](client1) {\textbf{Client1}};
...
\node[rect,fill=red!60,minimum width=2cm,below of=client3](client4) {\textbf{Client4}};
