...
\# getConnectAddr() : Optional<InetSocketAddress> \\
\# checkHostname(hostname : String) : boolean \\
\# checkPort(port : int) : boolean \\
\# getHostnameInput() : String \\
\# getPortInput() : String \\
\# onActivityResult(requestCode : int, resultCode : int, data : Intent) \\
\# startKeyChooserForResult() \\
\# startStreamViewer(addr : InetSocketAddress, keyFile : File) \\
...
\# showErrorDialog(msg : String, clickHandler : OnClickListener) \\
