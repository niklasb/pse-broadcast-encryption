...
+ onOptionsItemSelected() : boolean \\ + togglePlay() \\ + isPlaying() : boolean
}
\end{tikzpicture}
...
+ getServers() : Map<String, File> \\ + addServer()
}
\end{tikzpicture}
...
+ connectToServer() \\ + onOptionsItemSelected() : boolean
}
\end{tikzpicture}
...
\# onCreate() \\ + onCreateOptionsMenu() : boolean
}
\end{tikzpicture}
...
+ getChosenFile() : Optional<File> \\ + onFileClick()
}
\end{tikzpicture}
