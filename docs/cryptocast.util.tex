...
\umlvirt{+ run() : int} \\ \umlvirt{\# start()} \\ \umlvirt{\# printf()} \\ \umlvirt{\# print()} \\ \umlvirt{\# println()} \\ \umlvirt{\# getErrorFormat() : String} \\ \umlvirt{\# fatalError()} \\ \umlvirt{\# exit()} \\ \umlvirt{\# usage()} \\ \umlvirt{\# getBasicUsage() : String} \\ \umlvirt{\# printAdditionalUsage()}
}
\end{tikzpicture}
...
\umlvirt{\# start()} \\ \umlvirt{\# mainloop()} \\ \umlvirt{\# performCommand()} \\ \umlvirt{\# error()} \\ \umlvirt{\# getPrompt() : String}
}
\end{tikzpicture}
