...
+ init() : void \\ + keyGen() : void \\ + addUser() : void \\ + revokeUser() : void \\ + authorizeUser() : void \\ + stream() : void \\ + showStatistics() : void \\ + showUsers() : void \\ + showInfo() : void
}
\end{tikzpicture}
...
+ createNewUser() : <any> \\ + getUserByName() : <any> \\ + getPersonalKey() : <any>
}
\end{tikzpicture}
